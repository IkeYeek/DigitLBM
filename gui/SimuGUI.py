...
class SimuGUI(object):
    ...
    def __init__(self, master, params):
        ...
        self.params = Label(self.master,
                            text="Puissance Laser: %d; Taille spot: %d; Taille moyenne grain: %d; randomisation: %d; "
                                 "Absorbance: %d; Energie req! %d "
                                 % (params["laser_power"], params["spot_size"], params["mean_beam_size"],
                                    params["randomness"], params["beam_absorbancy"], params["melting_point"]))
